        ...
        {out.map((status, index) => (
          ...
          >
            <div className="flex items-center">
              ...
              <span
                className={cn(
                  "text-nowrap group-hover:overflow-visible group-hover:z-10 group-hover:shadow-lg group-hover:px-1 group-hover:bg-neutral-800/60 group-hover:rounded-md group-hover:backdrop-blur-md",
                  status.percentage < 10 && selectedStatus !== status.id
                    ? "hidden group-hover:block"
                    : "",
                  index !== out.length - 1 ? "overflow-hidden" : "",
                )}
              >
